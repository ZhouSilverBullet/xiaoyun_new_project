...
//            e.printStackTrace();
     ...
     */
    public void takePicture(final CustomCameraActivity context, Camera.PictureCallback pictureCallback) {
        if (camera != null) {
            //拍照
            try {
                ...
                Toast.makeText(context, "小云还没有准备好", Toast.LENGTH_SHORT).show();
